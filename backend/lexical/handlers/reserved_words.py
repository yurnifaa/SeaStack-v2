...
class ReservedWords:  
    ...
    def rw5(self): return self.check_delim(Delimiters._get_delimiters()["WHITESPACE"], self.rw6)
    ...
    def rw21(self): return self.check_delim(Delimiters._get_delimiters()["BOOL_DELIM"], self.rw22)
    ...
    def rw30(self): return self.check_delim(Delimiters._get_delimiters()["WHITESPACE"], self.rw31)
    ...
    def rw40(self): return self.check_delim(Delimiters._get_delimiters()["WHITESPACE"], self.rw41)
    ...
    def rw45(self): return self.check_delim(Delimiters._get_delimiters()["WHITESPACE"], self.rw46)
    ...
    def rw50(self): return self.check_delim(Delimiters._get_delimiters()["WHITESPACE"], self.rw51)
    ...
    def rw89(self): return self.check_delim(Delimiters._get_delimiters()["WHITESPACE"], self.rw90)
    ...
    def rw97(self): return self.check_delim(Delimiters._get_delimiters()["WHITESPACE"], self.rw98)
    ...
    def rw101(self): return self.check_delim(Delimiters._get_delimiters()["BOOL_DELIM"], self.rw102)
    ...
    def rw107(self): return self.check_delim(Delimiters._get_delimiters()["WHITESPACE"], self.rw108)
    ...
    def rw118(self): return self.check_delim(Delimiters._get_delimiters()["WHITESPACE"], self.rw119)
